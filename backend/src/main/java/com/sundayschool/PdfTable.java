...
public class PdfTable  {
    ...
    // Step-1 Creating a PdfDocument object
	    ...
	    p3.setFontSize(8);
	    p3.setBold();
	    p3.setFixedPosition(120, 220, null);
	    
	    Paragraph p4 = new Paragraph("TREASURER :");
	    p4.setFontSize(8);
	    p4.setBold();
	    p4.setFixedPosition(300, 220, null);
	    
	    Paragraph p5 = new Paragraph("PRESIDENT :");
	    p5.setFontSize(8);
	    p5.setBold();
	    p5.setFixedPosition(500, 220, null);
